...
public class FrontServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        Map<String, Map<String, Method>> urlMapping = (Map<String, Map<String, Method>>) getServletContext()
        ...
        if (methodsForUrl != null) {
            method = methodsForUrl.get(httpMethod);
        }
                ...
                if (pattern.contains("{") && pattern.contains("}")) {
                    ...
                    if (pathParams != null) {
                        ...
                        if (methodsForPattern != null) {
                            method = methodsForPattern.get(httpMethod);
                            if (method != null) {
                                break;
                            }
                        }
